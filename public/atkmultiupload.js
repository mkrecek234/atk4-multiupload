...
/******/ 	return __webpack_require__(__webpack_require__.s = "./src/multiupload.js");
/******/ })
/************************************************************************/
/******/ ({
...
/*!***********************!*\
  !*** ./src/plugin.js ***!
  \***********************/
/*! exports provided: plugin, createAtkplugins */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "plugin", function() { return plugin; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "createAtkplugins", function() { return createAtkplugins; });
...
/* harmony import */ var _plugins_multifile_upload_plugin__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./plugins/multifile-upload.plugin */ "./src/plugins/multifile-upload.plugin.js");
...
function plugin(name, className) {
  ...
  if (!jquery__WEBPACK_IMPORTED_MODULE_4___default.a.atk) {
    jquery__WEBPACK_IMPORTED_MODULE_4___default.a.atk = new Object();
  }

  ;
  var pluginName = 'atk' + name;
  var dataName = "__".concat(pluginName);
  var old = jquery__WEBPACK_IMPORTED_MODULE_4___default.a.fn[pluginName]; // add plugin to atk namespace.

  jquery__WEBPACK_IMPORTED_MODULE_4___default.a.atk[name] = className; // register plugin to jQuery fn prototype.

  jquery__WEBPACK_IMPORTED_MODULE_4___default.a.fn[pluginName] = function () {
    ...
    return this.each(function () {
      var options = jquery__WEBPACK_IMPORTED_MODULE_4___default.a.extend({}, className.DEFAULTS, _babel_runtime_helpers_typeof__WEBPACK_IMPORTED_MODULE_3___default()(option) === 'object' && option); // create plugin using the constructor function store in atk namespace object
      // and add a reference of it to this jQuery object data.

      jquery__WEBPACK_IMPORTED_MODULE_4___default()(this).data(dataName, new jquery__WEBPACK_IMPORTED_MODULE_4___default.a.atk[name](this, options));
    });
  }; // - Short hand


  if (shortHand) {
    jquery__WEBPACK_IMPORTED_MODULE_4___default.a[pluginName] = function (options) {
      return jquery__WEBPACK_IMPORTED_MODULE_4___default()({})[pluginName](options);
    };
  } // - No conflict


  jquery__WEBPACK_IMPORTED_MODULE_4___default.a.fn[pluginName].noConflict = function () {
    return jquery__WEBPACK_IMPORTED_MODULE_4___default.a.fn[pluginName] = old;
  };
}
/**
...
function createAtkplugins() {
  var atkJqPlugins = [{
    ...
    plugin: _plugins_multifile_upload_plugin__WEBPACK_IMPORTED_MODULE_5__["default"],
    sh: false
  }];
  atkJqPlugins.forEach(function (atkJqPlugin) {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return atkPlugin; });
...
var atkPlugin = /*#__PURE__*/function () {
  /**
  ...
  function atkPlugin(element, options) {
    _babel_runtime_helpers_classCallCheck__WEBPACK_IMPORTED_MODULE_1___default()(this, atkPlugin);

    this.$el = jquery__WEBPACK_IMPORTED_MODULE_3___default()(element);
  ...
  _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_2___default()(atkPlugin, [{
    key: "main",
    value: function main() {}
    /**
    ...
    value: function call(fn, args) {
      return this[fn].apply(this, _babel_runtime_helpers_toConsumableArray__WEBPACK_IMPORTED_MODULE_0___default()(args));
    }
  }]);
...
/***/ "./src/plugins/multifile-upload.plugin.js":
/*!************************************************!*\
  !*** ./src/plugins/multifile-upload.plugin.js ***!
  \************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return multifileUpload; });
...
/* harmony import */ var _atk_plugin__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./atk.plugin */ "./src/plugins/atk.plugin.js");
/* harmony import */ var _services_multiupload_service__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ../services/multiupload.service */ "./src/services/multiupload.service.js");
...
var multifileUpload = /*#__PURE__*/function (_atkPlugin) {
  _babel_runtime_helpers_inherits__WEBPACK_IMPORTED_MODULE_10___default()(multifileUpload, _atkPlugin);

  var _super = _createSuper(multifileUpload);

  function multifileUpload() {
    _babel_runtime_helpers_classCallCheck__WEBPACK_IMPORTED_MODULE_8___default()(this, multifileUpload);

    return _super.apply(this, arguments);
  }

  _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_9___default()(multifileUpload, [{
    key: "main",
    value: function main() {
    ...
    value: function setInitialState() {
      ...
      this.$el.data().fileId = this.settings.file.id; //this.hiddenInput.val(this.settings.file.id);
    ...
    key: "updateField",
    value: function updateField(fileId, fileName) {
      var arr = [];
      var fileIdList;
    ...
    value: function setEventHandler() {
      ...
      this.$el.on('click', '> .label > .filetitle', function (e) {
        var id = jquery__WEBPACK_IMPORTED_MODULE_13___default()(this).parent().data('value');
      ...
      this.fileInput.on('change', function (e) {
        if (e.target.files.length > 0) {
          that.textInput.val(e.target.files[0].name); //that.doFileUpload(e.target.files[0]);
    ...
    key: "domultiFileUpload",
    value: function domultiFileUpload(file) {
      var that = this; // if submit button id is set, then disable submit
      // during upload.

      if (this.settings.submit) {
        jquery__WEBPACK_IMPORTED_MODULE_13___default()('#' + this.settings.submit).addClass('disabled');
      ...
      var completeCb = function completeCb(response, content) {
        ...
        if (that.settings.submit) {
          jquery__WEBPACK_IMPORTED_MODULE_13___default()('#' + that.settings.submit).removeClass('disabled');
        }
      ...
      that.bar.show();
      _services_multiupload_service__WEBPACK_IMPORTED_MODULE_15__["default"].multiuploadFiles(file, this.$el, {
        action: 'upload'
    ...
    value: function doFileDelete(fileName) {
      ...
      this.$el.api({
        ...
        onComplete: function onComplete(response, content) {
          if (response.success) {//  that.setState('upload');
          }
        }
      });
    }
    ...
    key: "doFileDownload",
    value: function doFileDownload(fileName) {
      var that = this;
      this.$el.api({
        on: 'now',
        url: this.settings.uri,
...
}(_atk_plugin__WEBPACK_IMPORTED_MODULE_14__["default"]);
...
/***/ "./src/services/multiupload.service.js":
/*!*********************************************!*\
  !*** ./src/services/multiupload.service.js ***!
  \*********************************************/
/*! exports provided: default */
...
var multiUploadService = /*#__PURE__*/function () {
  _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_2___default()(multiUploadService, null, [{
    key: "getInstance",
  ...
  function multiUploadService() {
    _babel_runtime_helpers_classCallCheck__WEBPACK_IMPORTED_MODULE_1___default()(this, multiUploadService);

    if (!multiUploadService.instance) {
      multiUploadService.instance = this;
    }

    return multiUploadService.instance;
  }
  /**
  ...
  _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_2___default()(multiUploadService, [{
    key: "multiuploadFiles",
    value: function multiuploadFiles(files, el) {
      var data = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : [];
      var uploadUrl = arguments.length > 3 ? arguments[3] : undefined;
      ...
      if (!jquery__WEBPACK_IMPORTED_MODULE_3___default.a.isEmptyObject(data)) {
        jquery__WEBPACK_IMPORTED_MODULE_3___default.a.each(data, function (key, el) {
  ...
  return multiUploadService;
}();

var multiuploadService = new multiUploadService();
Object.freeze(multiuploadService);
/* harmony default export */ __webpack_exports__["default"] = (multiuploadService);
...
//# sourceMappingURL=atkmultiupload.js.map