...
/* harmony import */ var _plugins_multifile_upload_plugin__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./plugins/multifile-upload.plugin */ "./src/plugins/multifile-upload.plugin.js");
...
function plugin(name, className, shortHand = false) {
  ...
  if (!jquery__WEBPACK_IMPORTED_MODULE_0___default.a.atk) {
    jquery__WEBPACK_IMPORTED_MODULE_0___default.a.atk = new Object();
  }

  ;
  let pluginName = 'atk' + name;
  let dataName = `__${pluginName}`;
  let old = jquery__WEBPACK_IMPORTED_MODULE_0___default.a.fn[pluginName]; // add plugin to atk namespace.

  jquery__WEBPACK_IMPORTED_MODULE_0___default.a.atk[name] = className; // register plugin to jQuery fn prototype.

  jquery__WEBPACK_IMPORTED_MODULE_0___default.a.fn[pluginName] = function (option = {}, args = []) {
    ...
    return this.each(function () {
      let options = jquery__WEBPACK_IMPORTED_MODULE_0___default.a.extend({}, className.DEFAULTS, typeof option === 'object' && option); // create plugin using the constructor function store in atk namespace object
      // and add a reference of it to this jQuery object data.

      jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).data(dataName, new jquery__WEBPACK_IMPORTED_MODULE_0___default.a.atk[name](this, options));
    });
  }; // - Short hand


  if (shortHand) {
    jquery__WEBPACK_IMPORTED_MODULE_0___default.a[pluginName] = options => jquery__WEBPACK_IMPORTED_MODULE_0___default()({})[pluginName](options);
  } // - No conflict


  jquery__WEBPACK_IMPORTED_MODULE_0___default.a.fn[pluginName].noConflict = () => jquery__WEBPACK_IMPORTED_MODULE_0___default.a.fn[pluginName] = old;
}
/**
...
function createAtkplugins() {
  const atkJqPlugins = [{
    ...
    plugin: _plugins_multifile_upload_plugin__WEBPACK_IMPORTED_MODULE_1__["default"],
    sh: false
  }];
...
/* harmony import */ var _services_multiupload_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../services/multiupload.service */ "./src/services/multiupload.service.js");



class multifileUpload extends _atk_plugin__WEBPACK_IMPORTED_MODULE_1__["default"] {
  main() {
  ...
  domultiFileUpload(file) {
    ...
    if (this.settings.submit) {
      jquery__WEBPACK_IMPORTED_MODULE_0___default()('#' + this.settings.submit).addClass('disabled');
    ...
    let completeCb = (response, content) => {
      ...
      if (that.settings.submit) {
        jquery__WEBPACK_IMPORTED_MODULE_0___default()('#' + that.settings.submit).removeClass('disabled');
      }
    ...
    that.bar.show();
    _services_multiupload_service__WEBPACK_IMPORTED_MODULE_2__["default"].multiuploadFiles(file, this.$el, {
...
class multiUploadService {
  ...
  multiuploadFiles(files, el, data = [], uploadUrl, completeCb = function (r, c) {}, xhrCb = function () {
