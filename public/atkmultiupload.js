...
/* harmony import */ var _plugins_multifile_upload_plugin__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./plugins/multifile-upload.plugin */ "./src/plugins/multifile-upload.plugin.js");
...
function plugin(name, className) {
  ...
  if (!jquery__WEBPACK_IMPORTED_MODULE_3___default.a.atk) {
    jquery__WEBPACK_IMPORTED_MODULE_3___default.a.atk = new Object();
  }

  ;
  let pluginName = 'atk' + name;
  let dataName = `__${pluginName}`;
  let old = jquery__WEBPACK_IMPORTED_MODULE_3___default.a.fn[pluginName]; // add plugin to atk namespace.

  jquery__WEBPACK_IMPORTED_MODULE_3___default.a.atk[name] = className; // register plugin to jQuery fn prototype.

  jquery__WEBPACK_IMPORTED_MODULE_3___default.a.fn[pluginName] = function () {
    ...
    return this.each(function () {
      let options = jquery__WEBPACK_IMPORTED_MODULE_3___default.a.extend({}, className.DEFAULTS, typeof option === 'object' && option); // create plugin using the constructor function store in atk namespace object
      // and add a reference of it to this jQuery object data.

      jquery__WEBPACK_IMPORTED_MODULE_3___default()(this).data(dataName, new jquery__WEBPACK_IMPORTED_MODULE_3___default.a.atk[name](this, options));
    });
  }; // - Short hand


  if (shortHand) {
    jquery__WEBPACK_IMPORTED_MODULE_3___default.a[pluginName] = options => jquery__WEBPACK_IMPORTED_MODULE_3___default()({})[pluginName](options);
  } // - No conflict


  jquery__WEBPACK_IMPORTED_MODULE_3___default.a.fn[pluginName].noConflict = () => jquery__WEBPACK_IMPORTED_MODULE_3___default.a.fn[pluginName] = old;
}
/**
...
function createAtkplugins() {
  const atkJqPlugins = [{
    ...
    plugin: _plugins_multifile_upload_plugin__WEBPACK_IMPORTED_MODULE_4__["default"],
    sh: false
  }];
...
/* harmony import */ var _services_multiupload_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../services/multiupload.service */ "./src/services/multiupload.service.js");
...
class multifileUpload extends _atk_plugin__WEBPACK_IMPORTED_MODULE_4__["default"] {
  main() {
  ...
  setEventHandler() {
    ...
    this.$el.on('click', '> .label > .filetitle', e => {
      let id = jquery__WEBPACK_IMPORTED_MODULE_3___default()(e.target).parent().data('value');
  ...
  domultiFileUpload(file) {
    const that = this; // if submit button id is set, then disable submit
    // during upload.

    if (this.settings.submit) {
      jquery__WEBPACK_IMPORTED_MODULE_3___default()('#' + this.settings.submit).addClass('disabled');
    ...
    let completeCb = (response, content) => {
      ...
      if (that.settings.submit) {
        jquery__WEBPACK_IMPORTED_MODULE_3___default()('#' + that.settings.submit).removeClass('disabled');
      }
    ...
    that.bar.show();
    _services_multiupload_service__WEBPACK_IMPORTED_MODULE_5__["default"].multiuploadFiles(file, this.$el, {
...
class multiUploadService {
  ...
  multiuploadFiles(files, el) {
    let data = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : [];
    let uploadUrl = arguments.length > 3 ? arguments[3] : undefined;
    ...
    if (!jquery__WEBPACK_IMPORTED_MODULE_0___default.a.isEmptyObject(data)) {
      jquery__WEBPACK_IMPORTED_MODULE_0___default.a.each(data, function (key, el) {
...
const multiuploadService = new multiUploadService();
